...
//   const handleLogin = async (e) => {
//     e.preventDefault();
//     // ... (keep your existing handleLogin code)
//   };
...
//                 type="button"
//                 className="btn w-100 mb-2"
//                 style={{ backgroundColor: showOtpField ? "#05254d" : "#28a745", color: "#fff", fontWeight: "600" }}
...
//                 type="button"
//                 className="btn w-100 mb-2"
//                 style={{ backgroundColor: "#6c757d", color: "#fff", fontWeight: "600" }}
//                 onClick={() => {
