...
const ViewOrders = () => {
    ...
    const columns = React.useMemo(
        () => [
            ...
            { Header: 'SNo.', Cell: ({ row }) => row.index + 1, id: 'sr_no' },
            {
                Header: 'Date',
                accessor: (row) => {
        ...
        <>
            ...
            <div className="main-container">
                <div className="customers-table-container">
                    ...
                    {loading ? <div>Loading...</div> : <DataTable columns={columns} data={[...data].reverse()} defaultSearch={searchValue}/>}
                </div>
            </div>
